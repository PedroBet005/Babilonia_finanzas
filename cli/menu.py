...
def print_financial_summary(diezmo, deudas, ahorro, disponible):
    ...
    print("🙏 " + t("tithe") + ":")
    print(f"├─ 💰 {t('amount')}: {diezmo}")

    print("🧾 " + t("debts") + ":")
    print(f"├─ 💰 {t('amount')}: {deudas}")

    print("🏦 " + t("savings") + ":")
    print(f"└─ 💰 {t('amount')}: {ahorro}")
...
def show_financial_tools_menu():
    while True:
        ...
        print(f"{1:>2}. 📊 {t('monthly_report')}")
        print(f"{2:>2}. 📅 {t('period_summary')}")
        print(f"{3:>2}. 📂 {t('expenses_by_category')}")
        print(f"{4:>2}. 🏺 {t('cash_flow')}")
        print(f"{5:>2}. 💰 {t('babylon_savings')}")
        print(f"{6:>2}. 📈 {t('financial_evolution')}")
        print(f"{7:>2}. 🧾 {t('export_financial_evolution')}")
        print(f"{8:>2}. 📊 {t('export_financial_chart')}")
        print(f"{9:>2}. 📂 {t('export_expenses_by_category')}")
        print(f"{10:>2}. 🏺 {t('menu_export_babylon_savings')}")
        print(f"{0:>2}. ⬅️ {t('back')}")
